...
func TestMain(m *testing.M) {
	config.LoadConfig()
	repo = NewBookRepository(config.DB)
...
func TestCreateBook(t *testing.T) {
	...
	res, err := repo.CreateBook(&newBook)
...
func TestGetBooks(t *testing.T) {
	res, err := repo.GetBooks(userId, false, 1, 10)
...
func TestGetBook(t *testing.T) {
	res, err := repo.GetBook(userId, bookId)
...
func TestUpdateBook(t *testing.T) {
	...
	res, err := repo.UpdateBook(&updated)
...
func TestArchiveBook(t *testing.T) {
	...
	res, err := repo.ArchiveBook(&archived)
